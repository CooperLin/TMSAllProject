...
#define APICityRoutesPathEn @"/xmlbus3/en/StaticData/GetRoute.xml"
#define APICityProvidersPath @"/xmlbus3/StaticData/GetProvider.xml"
#define APICityProvidersPathEn @"/xmlbus3/en/StaticData/GetProvider.xml"

//國道客運
#define APIHighwayRoutesPath @"/xmlbusgz/StaticData/GetRoute.xml"
#define APIHighwayRoutesPathEn @"/xmlbusgz/en/StaticData/GetRoute.xml"
#define APIHighwayProvidersPath @"/xmlbusgz/StaticData/GetProvider.xml"
#define APIHighwayProvidersPathEn @"/xmlbusgz/en/StaticData/GetProvider.xml"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([self.LocalizedTable rangeOfString:@"TW"].location != NSNotFound) {
        isCht = YES;
    } else {
        isCht = NO;
    }
...
-(void)addRequests
{
    ...
    if (![DataManager checkUpdatedTodayByType:RouteDataTypeCityRoutes])
    {
        ...
        [self.requestManager addRequestWithKey:@"CityRoutes" andUrl:[NSString stringWithFormat:@"%@%@",APIServer,str] byType:RequestDataTypeXML];
    }
    if (![DataManager checkUpdatedTodayByType:RouteDataTypeHighwayRoutes])
    {
        NSString *str = isCht?APIHighwayRoutesPath:APIHighwayRoutesPathEn;
        [self.requestManager addRequestWithKey:@"HighwayRoutes" andUrl:[NSString stringWithFormat:@"%@%@",APIServer,str] byType:RequestDataTypeXML];
    }
    if (![DataManager checkUpdatedTodayByType:RouteDataTypeCityProviders])
    {
        NSString *str = isCht?APICityProvidersPath:APICityProvidersPathEn;
        [self.requestManager addRequestWithKey:@"CityProviders" andUrl:[NSString stringWithFormat:@"%@%@",APIServer,str] byType:RequestDataTypeXML];
    }
    if (![DataManager checkUpdatedTodayByType:RouteDataTypeHighwayProviders])
    {
        NSString *str = isCht?APIHighwayProvidersPath:APIHighwayProvidersPathEn;
        [self.requestManager addRequestWithKey:@"HighwayProviders" andUrl:[NSString stringWithFormat:@"%@%@",APIServer,str] byType:RequestDataTypeXML];
    }
}
