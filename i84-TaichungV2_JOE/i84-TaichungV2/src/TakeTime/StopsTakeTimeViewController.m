...
#define APIGetPathTime @"/itravel/itravelAPI/ExpoAPI/TravelTime.aspx?Departure=%@&Destination=%@&Time=%@"
#define APIGetPathTimeEn @"/itravel/itravelAPI/ExpoAPI/TravelTime.aspx?Departure=%@&Destination=%@&Time=%@&Lang=En"
...
//            stringEncodedDestination = @"229,140,151,229,177,175,229,156,139,229,176,143,40,229,140,151,229,177,175,232,183,175,41,";
            ...
            NSString *str = isCht?APIGetPathTime:APIGetPathTimeEn;
            stringAPI = [NSString stringWithFormat:str,stringEncodedDeparture,stringEncodedDestination,stringDateNow];
