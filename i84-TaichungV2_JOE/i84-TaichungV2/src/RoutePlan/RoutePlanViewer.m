...
#define RoutePlanAPI @"%@/iTravel/iTravel_WS/Service.asmx/JsonTravelPlan?SPx=%.6f&SPy=%.6f&EPx=%.6f&EPy=%.6f&GoDay=%@&GoTime=%@&Lang=cht&Mode=%@&UserPickPlace=&source=I&SName=%@&EName=%@&SType=%@&EType=%@"
#define RoutePlanAPIEn @"%@/iTravel/iTravel_WS/Service.asmx/JsonTravelPlan?SPx=%.6f&SPy=%.6f&EPx=%.6f&EPy=%.6f&GoDay=%@&GoTime=%@&Lang=en&Mode=%@&UserPickPlace=&source=I&SName=%@&EName=%@&SType=%@&EType=%@"
...
//    [LocationSeg setTitle:NSLocalizedStringFromTable(@"公司_seg", appDelegate.LocalizedTable, nil) forSegmentAtIndex:1];
    [LocationSeg setTitle:@"家" forSegmentAtIndex:0];
    [LocationSeg setTitle:@"公司" forSegmentAtIndex:1];
...
- (void) SendRoutePlanRequestByMode:(NSString*)stringMode onDate:(NSString*)stringDay atTime:(NSString *)stringTime
{
    ...
    NSString *str = isCht?RoutePlanAPI:RoutePlanAPIEn;
    NSString * urlstr = [[NSString alloc] initWithFormat:str,APIServer,slon,slat,elon,elat,stringDay,stringTime,stringMode,sname,ename,stype,etype];
