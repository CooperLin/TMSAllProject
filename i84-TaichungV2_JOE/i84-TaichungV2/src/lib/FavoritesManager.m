...
#define APISelectEn @"%@/itravel/ItravelAPI/ExpoAPI/GetOrderStop.aspx?Did=%@&Phone=iPhone&City=Taichung&Lang=En"
...
- (void) SendSynchronousRequest
{
    ...
    NSString *str = isCht?APISelect:APISelectEn;
    
    NSString * UrlStr = [NSString stringWithFormat:str,APIServer,[PushManager GetToken]];
