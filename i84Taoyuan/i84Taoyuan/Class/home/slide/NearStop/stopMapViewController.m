...
-(void)actSetMap
{
    ...
    NSString * stringLatitude = [dictionaryStop objectForKey:@"Lat"];
    NSString * stringLongtitude = [dictionaryStop objectForKey:@"Lon"];
    ...
    annotation.title = [NSString stringWithFormat:@"%@ %@",[dictionaryStop objectForKey:@"PathName"],[dictionaryStop objectForKey:@"StopName"]];
    int intToward = [[dictionaryStop objectForKey:@"GoBack"]intValue];
    NSString * stringKey = intToward?@"Dest":@"Dept";
    annotation.subtitle = [NSString stringWithFormat:@"往 %@",[dictionaryStop objectForKey:stringKey]];
    MKCoordinateSpan theSpan = MKCoordinateSpanMake(0.01, 0.01);
